...
java_cpp %>% 
  ...
  tab_style(
    ...
    locations = cells_column_spanners("Bettina")
  ) %>%
  tab_style(
    style = cell_text(weight = "bold"),
...
maria_payoffs %>% 
  ...
  tab_style(
    style = cell_text(weight = "bold"),
    locations = cells_column_spanners("Nonprofit 2")
  ) %>%
  tab_style(
    style = cell_text(weight = "bold"),
    locations = cells_body(columns = 1)
...
```{r pd-payoffs, echo=FALSE, indent="    "}
...
pd_payoffs %>% 
  ...
  tab_style(
    style = cell_text(weight = "bold"),
    locations = cells_column_spanners("Farmer 2")
  ) %>% 
  tab_style(
    style = cell_text(weight = "bold"),
    locations = cells_body(columns = 1)
...
```
    ...
    c. What is/are the Pareto efficient outcome(s) in this game?
...
```{r stag-payoffs, echo=FALSE, indent="    "}
choices <- c("1 cow", "2+ cows")
players <- c("Farmer 1", "Farmer 2")
